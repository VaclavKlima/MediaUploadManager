...
| --- | --- |
| app/{Actions,Console,Http,Support}/** | .ai/rules/actions-console-http-support.md |
| app/{Actions,Http,Models,Support/Media}/** | .ai/rules/actions-http-models-support-media.md |
...
| app/{Models,Actions,Jobs,Support/Media}/** | .ai/rules/models-actions-jobs-support-media.md |
...
| {app/Actions/**,app/Enums/UploadStatus.php,resources/js/components/series-upload/**} | .ai/rules/series-upload.md |
| {app/Actions/Series/**,resources/js/{components/series-upload,composables}/**} | .ai/rules/series-uploadcomposables.md |
...
| {app/Support/Media/LocalTusDevelopmentEnvironment.php,deploy/tus/**} | .ai/rules/tus.md |
